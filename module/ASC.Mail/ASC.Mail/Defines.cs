...
namespace ASC.Mail
{
    public class Defines
    {
        ...
        {
            get { return ConfigurationManager.AppSettings["mail.daemon-email"] ?? "mail-daemon@EKTAIOFFICE.com"; }
        }
        ...
        public static string ServerDnsDomainCheckPrefix
        {
            get
            {
                return ConfigurationManager.AppSettings["mail.server-dns-check-prefix"] ?? "EKTAIOFFICE-domain";
            }
        }
