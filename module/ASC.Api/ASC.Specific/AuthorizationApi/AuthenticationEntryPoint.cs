...
namespace ASC.Specific.AuthorizationApi
{
    ...
    public class AuthenticationEntryPoint : IApiEntryPoint
    {
        ...
        /// <summary>
        /// Request of invitation by email on personal.EKTAIOFFICE.com
        /// </summary>
        /// <param name="email">Email address</param>
        /// <param name="lang">Culture</param>
        /// <param name="spam">User consent to subscribe to the EKTAIOFFICE newsletter</param>
        ...
        {
            if (!CoreContext.Configuration.Personal) throw new MethodAccessException("Method is only available on personal.EKTAIOFFICE.com");
