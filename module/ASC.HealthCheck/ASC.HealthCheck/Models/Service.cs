...
namespace ASC.HealthCheck.Models
{
    public abstract class Service : ICloneable
    {
        ...
        public static Service CreateNewService(ServiceEnum serviceEnum)
        {
            switch (serviceEnum)
            {
                case ServiceEnum.EKTAIOFFICEJabber:
                    return new EKTAIOFFICEJabberService();
                case ServiceEnum.EKTAIOFFICESignalR:
                    return new EKTAIOFFICESignalRService();
                case ServiceEnum.EKTAIOFFICENotify:
                    return new EKTAIOFFICENotifyService();
                case ServiceEnum.EKTAIOFFICEBackup:
                    return new EKTAIOFFICEBackupService();
                case ServiceEnum.EKTAIOFFICEFeed:
                    return new EKTAIOFFICEFeedService();
                case ServiceEnum.EKTAIOFFICEMailAggregator:
                    return new EKTAIOFFICEMailAggregatorService();
                case ServiceEnum.EKTAIOFFICEMailWatchdog:
                    return new EKTAIOFFICEMailWatchdogService();
                case ServiceEnum.EKTAIOFFICEAutoreply:
                    return new EKTAIOFFICEAutoreplyService();
                case ServiceEnum.EKTAIOFFICEIndex:
                    return new EKTAIOFFICEIndexService();
    ...
    public class EKTAIOFFICEJabberService : Service
    {
        public EKTAIOFFICEJabberService() : base(ServiceEnum.EKTAIOFFICEJabber)
        {
        }
    ...
    public class EKTAIOFFICESignalRService : Service
    {
        public EKTAIOFFICESignalRService() : base(ServiceEnum.EKTAIOFFICESignalR)
        {
        }
    ...
    public class EKTAIOFFICENotifyService : Service
    {
        public EKTAIOFFICENotifyService() : base(ServiceEnum.EKTAIOFFICENotify) { }
    ...
    public class EKTAIOFFICEBackupService : Service
    {
        public EKTAIOFFICEBackupService() : base(ServiceEnum.EKTAIOFFICEBackup) { }
    ...
    public class EKTAIOFFICEFeedService : Service
    {
        public EKTAIOFFICEFeedService() : base(ServiceEnum.EKTAIOFFICEFeed) { }
    ...
    public class EKTAIOFFICEMailAggregatorService : Service
    {
        public EKTAIOFFICEMailAggregatorService() : base(ServiceEnum.EKTAIOFFICEMailAggregator) { }
    ...
    public class EKTAIOFFICEMailWatchdogService : Service
    {
        public EKTAIOFFICEMailWatchdogService() : base(ServiceEnum.EKTAIOFFICEMailWatchdog) { }
    ...
    public class EKTAIOFFICEAutoreplyService : Service
    {
        public EKTAIOFFICEAutoreplyService() : base(ServiceEnum.EKTAIOFFICEAutoreply)
        {
        }
    ...
    public class EKTAIOFFICEIndexService : Service
    {
        public EKTAIOFFICEIndexService() : base(ServiceEnum.EKTAIOFFICEIndex) { }
    ...
    public class MiniChatService : Service
    {
        ...
        public override string Check(int tenantId)
        {
            return new EKTAIOFFICESignalRService().Check(tenantId);
        }
    }
}