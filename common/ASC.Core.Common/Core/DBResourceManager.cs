            ...
            if (HttpContext.Current != null) //if in Notify Service or other process without HttpContext
            {
                try
                {
                    ...
                    if (whiteLabelDictionary.TryGetValue(tenant.TenantId, out newText))
                    {
                        ...
                        //Hack for resource strings with mails looked like ...@EKTAIOFFICE... or with website http://www.EKTAIOFFICE.com link or with the https://www.facebook.com/pages/EKTAIOFFICE/833032526736775
