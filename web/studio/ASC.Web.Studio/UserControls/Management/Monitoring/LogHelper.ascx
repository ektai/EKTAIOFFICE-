    ...
    <div class="settings-block">
        ...
        <p class="monitoring-describe">
             <% if (!string.IsNullOrEmpty(HelpLink))
                { %>
            <%= string.Format(MonitoringResource.ContactUsText.HtmlEncode(), "<a href=\"" + HelpLink + "/faq/faq.aspx\" class=\"gray link underline\">", "</a>", "<a href=\"mailto:support@EKTAIOFFICE.com\")  class=\"gray link underline\">", "</a>") %>
            <% }
                else
                { %>
            <%= string.Format(MonitoringResource.ContactUsText2.HtmlEncode(), "<a href=\"mailto:support@EKTAIOFFICE.com\") class=\"gray link underline\">", "</a>") %>
            <% } %>
        </p>
