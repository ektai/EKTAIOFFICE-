...
<div id="operationBlock" runat="server">
    ...
    <%if (!CoreContext.Configuration.CustomMode){%>
        <%= string.Format(Resource.DeleteProfileConfirmationInfo, "<a href='https://www.EKTAIOFFICE.com/legalterms.aspx' target='_blank'>", "</a>") %>
    <% } %>
...
<div id="result" runat="server">
    ...
    <%if (!CoreContext.Configuration.CustomMode){%>
        <%= string.Format(Resource.DeleteProfileSuccessMessageInfo, "<a href='https://www.EKTAIOFFICE.com/legalterms.aspx' target='_blank'>", "</a>")%>
    <% } %>
</div>
