...
<div class="cookieMess">
    <div class="cookieMess_container">
        <p><%= String.Format(Resource.CookieMessText.HtmlEncode(), "<a target=\"_blank\" href=\"https://help.EKTAIOFFICE.com/products/files/doceditor.aspx?fileid=5048502&doc=SXhWMEVzSEYxNlVVaXJJeUVtS0kyYk14YWdXTEFUQmRWL250NllHNUFGbz0_IjUwNDg1MDIi0&_ga=2.239950403.1196593722.1525950411-169631771.1404734630\">", "</span>") %></p>
    ...
    <div class="auth-form-with auth-form-access">
        <div class="auth-form-access-container">
            ...
            <div class="access-text">
                ...
                <p class="access-text-content">
                    <%= String.Format(Resource.AuthDocsAccessOfflineText, "<a class=\"access-href\" href=\"https://www.EKTAIOFFICE.com/download-desktop.aspx\">" + Resource.AuthDocsAccessEKTAIOFFICEDesktop + "</a>") %>
                </p>
            </div>
            <div class="access-text">
                ...
                <a href="https://itunes.apple.com/app/EKTAIOFFICE-documents/id944896972?mt=8" class="access-apple"></a>
                <a href="https://play.google.com/store/apps/details?id=com.EKTAIOFFICE.documents" class="access-android"></a>
                ...
                <label>
                    ...
                    <label for="agree_to_terms">
                        <%= String.Format(Resource.RegistrySettingTerms.HtmlEncode(),
                                                                  ...
                                                                  "<a target=\"_blank\" href=\"https://help.EKTAIOFFICE.com/products/files/doceditor.aspx?fileid=5048502&doc=SXhWMEVzSEYxNlVVaXJJeUVtS0kyYk14YWdXTEFUQmRWL250NllHNUFGbz0_IjUwNDg1MDIi0&_ga=2.248662407.1867121315.1526272545-169631771.1404734630\">", "</a>") %></label>
                </label>
            </div>
            <div class="auth-form-setting">
                <label>
