...
<script type="text/javascript" language="javascript">
    ...
    ga('require', 'linker');
    ga('www.linker:autoLink', ['EKTAIOFFICE.com', 'EKTAIOFFICE.eu', 'EKTAIOFFICE.sg', 'avangate.com'], false, true);
    ...
    ga('require', 'linker');
    ga('testTracker.linker:autoLink', ['EKTAIOFFICE.com', 'EKTAIOFFICE.eu', 'EKTAIOFFICE.sg', 'avangate.com'], false, true);
