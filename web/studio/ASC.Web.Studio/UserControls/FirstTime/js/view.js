    ...
    this.Finish = function() {
        ...
        try {
            if (window.ga) {
                ...
                window.ga('www.send', 'event', 'EKTAIOFFICE_adwords', 'wizard_finish');
                window.ga('testTracker.send', 'pageview', '/wizard_finish');
                window.ga('testTracker.send', 'event', 'EKTAIOFFICE_adwords', 'wizard_finish');
            }
            window.uetq = window.uetq || [];
            window.uetq.push({ 'ec': 'EKTAIOFFICE_msn', 'ea': 'clickto', 'el': 'onbutton', 'ev': '1' });
        } catch(err) {
        }
