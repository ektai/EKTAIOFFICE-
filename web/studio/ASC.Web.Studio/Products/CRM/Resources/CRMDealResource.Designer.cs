...
namespace ASC.Web.CRM.Resources {
    ...
    public class CRMDealResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Match your file columns with the corresponding EKTAIOFFICE™ CRM fields. Please pay your attention to the fact that to import opportunities correctly you need to have at least the following columns from your file matched with the fields of the EKTAIOFFICE™ CRM: &apos;Opportunity Title&apos;, &apos;Opportunity Responsible&apos;. The fields containing the dates must have the following format: {0}. The currency field must be set in accordance with the international three letter code (e.g. USD, JPY, AUD)..
        /// </summary>
