...
namespace ASC.Web.CRM.Resources {
    ...
    public class CRMContactResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Match your file columns with the corresponding EKTAIOFFICE™ CRM fields. Please pay your attention to the fact that to import persons correctly you need to have at least one column from your file matched with the &apos;First Name&apos; field of the EKTAIOFFICE™ CRM. The same is for the company import, you will need to match the &apos;Company Name&apos; field to be able to import a company. The fields containing the dates must have the following format: {0}..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to No matches in EKTAIOFFICE™ CRM, select from list.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to We will add the text watermark to your letter like &quot;Powered by EKTAIOFFICE.com&quot;. You can see it in the next (message preview) step..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to CSV (comma-separated values) files store tabular data in the plain-text form. You can create such files from any spreadsheets using EKTAIOFFICE™ Documents..
        /// </summary>
