...
namespace ASC.Web.CRM.Resources {
    ...
    public class CRMTaskResource {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Match your file columns with the corresponding EKTAIOFFICE™ CRM fields. Please pay your attention to the fact that to import tasks correctly you need to have at least the following columns from your file matched with the fields of the EKTAIOFFICE™ CRM: &apos;Task Title&apos;, &apos;Responsible&apos;, &apos;Due Date&apos;. The fields containing the dates must have the following format: {0}..
        /// </summary>
