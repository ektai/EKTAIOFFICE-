...
window.ASC.Files.ThirdParty = (function () {
    ...
    var thirdPartyList = {
        ...
        Google: { key: "Google", customerTitle: ASC.Files.FilesJSResources.FolderTitleGoogle, providerTitle: ASC.Files.FilesJSResources.TypeTitleGoogle, getTokenUrl: "http://www.EKTAIOFFICE.com" },
    ...
    var isDifferentThirdParty = function (id1, id2) {
        ...
        var getAccId = function (id) {
            var EKTAIOFFICERegExp = /^\d+/;
            var accId = EKTAIOFFICERegExp.exec(id);
            if (accId != null) {
                return "EKTAIOFFICE";
            }
