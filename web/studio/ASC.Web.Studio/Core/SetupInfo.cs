...
namespace ASC.Web.Studio.Core
{
    public static class SetupInfo
    {
        ...
        {
            MetaImageURL = GetAppSettings("web.meta-image-url", "https://download.EKTAIOFFICE.com/assets/fb/fb_icon_325x325.jpg");
            ...
            DownloadForDesktopUrl = GetAppSettings("web.download.for.desktop.url", "https://www.EKTAIOFFICE.com/desktop.aspx");
            DownloadForIosDocuments = GetAppSettings("web.download.for.ios.doc", "https://itunes.apple.com/app/EKTAIOFFICE-documents/id944896972");
            DownloadForIosProjects = GetAppSettings("web.download.for.ios.proj", "https://itunes.apple.com/app/EKTAIOFFICE-projects/id1353395928?mt=8");
            DownloadForAndroidDocuments = GetAppSettings("web.download.for.android.doc", "https://play.google.com/store/apps/details?id=com.EKTAIOFFICE.documents");
            ...
            SalesEmail = GetAppSettings("web.payment.email", "sales@EKTAIOFFICE.com");
            ...
            TfaAppSender = GetAppSettings("web.tfaapp.backup.title", "EKTAIOFFICE");
