                ...
                try
                {
                    ...
                    if (quota.Trial)
                    {
                        ...
                        else if (createdDate.AddDays(7) == nowDate)
                        {
                            ...
                            tableItemLearnMoreUrl1 = StudioNotifyHelper.Helplink + "/EKTAIOFFICE-editors/index.aspx";
                        ...
                        else if (dueDateIsNotMax && dueDate.AddDays(5) == nowDate && tenant.VersionChanged <= tenant.CreatedDateTime)
                        {
                            ...
                            greenButtonUrl = "mailto:sales@EKTAIOFFICE.com";
                        }
                        ...
                        else if (dueDateIsNotMax && dueDate.AddDays(30) == nowDate && CoreContext.UserManager.GetUsers().Count() == 1)
                        {
                            ...
                            greenButtonUrl = "https://personal.EKTAIOFFICE.com";
                        }
                    ...
                    foreach (var u in users.Where(u => paymentMessage || StudioNotifyHelper.IsSubscribedToNotify(u, Actions.PeriodicNotify)))
                    {
                        ...
                        client.SendNoticeToAsync(
                            ...
                            TagValues.BlueButton(blueButtonText, "http://www.EKTAIOFFICE.com/call-back-form.aspx"),
                ...
                try
                {
                    ...
                    if (quota.Trial && defaultRebranding)
                    {
                        ...
                        else if (dueDateIsNotMax && dueDate.AddDays(-7) == nowDate)
                        {
                            ...
                            greenButtonUrl = "http://www.EKTAIOFFICE.com/enterprise-edition.aspx";
                        }
            ...
            foreach (var tenant in activeTenants)
            {
                try
                {
                    ...
                    if (createdDate.AddDays(7) == nowDate)
                    {
                        ...
                        greenButtonUrl = "https://www.EKTAIOFFICE.com/enterprise-edition-free.aspx";
                    }
                    ...
                    else if (createdDate.AddDays(21) == nowDate)
                    {
                        ...
                        tableItemLearnMoreUrl1 = StudioNotifyHelper.Helplink + "/EKTAIOFFICE-Editors/EKTAIOFFICE-Document-Editor/HelpfulHints/CollaborativeEditing.aspx";
                        tableItemLearnMoreText1 = () => WebstudioNotifyPatternResource.LinkLearnMore;
                        ...
                        tableItemLearnMoreUrl2 = StudioNotifyHelper.Helplink + "/EKTAIOFFICE-Editors/EKTAIOFFICE-Document-Editor/UsageInstructions/ViewDocInfo.aspx";
                        ...
                        tableItemLearnMoreUrl3 = StudioNotifyHelper.Helplink + "/EKTAIOFFICE-Editors/EKTAIOFFICE-Document-Editor/HelpfulHints/Review.aspx";
                        ...
                        tableItemLearnMoreUrl5 = StudioNotifyHelper.Helplink + "/EKTAIOFFICE-Editors/EKTAIOFFICE-Document-Editor/UsageInstructions/UseMailMerge.aspx";
                        ...
                        tableItemLearnMoreUrl6 = "http://www.EKTAIOFFICE.com/desktop.aspx";
                        ...
                        tableItemLearnMoreUrl7 = "https://itunes.apple.com/us/app/EKTAIOFFICE-documents/id944896972";
