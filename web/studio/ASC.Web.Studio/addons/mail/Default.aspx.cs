...
namespace ASC.Web.Mail
{
    public partial class MailPage : MainPage, IStaticBundle
    {
        ...
        private const string DEFAULT_FAQ_URL = "http://helpcenter.EKTAIOFFICE.com/" + MAIL_TROUBLESHOOTING;
        ...
        {
            return WebConfigurationManager.AppSettings["mail.daemon-email"] ?? "mail-daemon@EKTAIOFFICE.com";
        }
