...
function fireNotification(obj, event) {
    ...
    if ((obj.photoPath.indexOf('http://') != -1 || obj.photoPath.indexOf('https://') != -1) && obj.photoPath != '') {
        ...
        photo = event.target.origin != '' ? event.target.origin + obj.photoPath : "http://download.EKTAIOFFICE.com/assets/logo/emptyuser-48.png";
    } else {
        photo = "http://download.EKTAIOFFICE.com/assets/logo/emptyuser-48.png";
    }
