...
<div id="talkTabContainer" class="studio-top-panel">
  ...
  <ul class="tabs">
   <!--<li class ="studio-top-logo" </li>
    <a class="top-logo" title="EKTAIOFFICE" href="#">
       <img alt="" src="https://d3b5653v7ash7c.cloudfront.net/studio/tag/nct.8.9.0/skins/default/images/EKTAIOFFICE_logo/light_small_general.png">
    </a> -->
