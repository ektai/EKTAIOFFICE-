...
namespace ASC.Web.Core.WhiteLabel
{
    ...
    {
        public const string DefaultLogoText = "EKTAIOFFICE";
        ...
        public static string GetAbsoluteDefaultLogoPath(WhiteLabelLogoTypeEnum type, bool general)
        {
            ...
            {
                case WhiteLabelLogoTypeEnum.LightSmall:
                    return general ? WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/light_small_general.svg") : WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/light_small.svg");
                case WhiteLabelLogoTypeEnum.Dark:
                    return general ? WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/dark_general.png") : WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/dark.png");
                case WhiteLabelLogoTypeEnum.DocsEditor:
                    return general ? WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/editor_logo_general.png") : WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/editor_logo.png");
                case WhiteLabelLogoTypeEnum.Favicon:
                    return general ? WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/favicon_general.ico") : WebImageSupplier.GetAbsoluteWebPath("EKTAIOFFICE_logo/favicon.ico");
            }
            return "";
        }
