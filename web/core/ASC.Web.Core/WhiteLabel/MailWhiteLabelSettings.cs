    ...
    public class MailWhiteLabelSettings : BaseSettings<MailWhiteLabelSettings>
    {
        ...
        public static string DefaultMailSupportUrl
        {
            get
            {
                ...
                return !string.IsNullOrEmpty(url) ? url : "http://support.EKTAIOFFICE.com";
            }
        }
        ...
        public static string DefaultMailSupportEmail
        {
            get
            {
                ...
                return !string.IsNullOrEmpty(email) ? email : "support@EKTAIOFFICE.com";
            }
        }
        ...
        public static string DefaultMailDemotUrl
        {
            get
            {
                ...
                return !string.IsNullOrEmpty(url) ? url : "http://www.EKTAIOFFICE.com/demo-order.aspx";
            }
        }
        ...
        public static string DefaultMailSiteUrl
        {
            get
            {
                ...
                return !string.IsNullOrEmpty(url) ? url : "http://www.EKTAIOFFICE.com";
            }
        }
