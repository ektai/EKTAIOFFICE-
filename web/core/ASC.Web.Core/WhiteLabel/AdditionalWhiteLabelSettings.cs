    ...
    public class AdditionalWhiteLabelSettings : BaseSettings<AdditionalWhiteLabelSettings>
    {
        ...
        public static string DefaultMailSalesEmail
        {
            get
            {
                ...
                return !string.IsNullOrEmpty(email) ? email : "sales@EKTAIOFFICE.com";
            }
        }
        ...
        public static string DefaultLicenseAgreements
        {
            get
            {
                return CultureInfo.CurrentUICulture.TwoLetterISOLanguageName == "ru" ? "https://help.EKTAIOFFICE.com/products/files/doceditor.aspx?fileid=4522572&doc=VzZXY2FQb29EdjZmTnhlZkFYZS9XYzFPK3JTaC9zcC9mNHEvTTZXSXNLUT0_IjQ1MjI1NzIi0" : "https://help.EKTAIOFFICE.com/products/files/doceditor.aspx?fileid=4485697&doc=R29zSHZNRi9LYnRTb3JDditmVGpXQThVVXhMTWdja0xwemlYZXpiaDBYdz0_IjQ0ODU2OTci0";
            }
        }
